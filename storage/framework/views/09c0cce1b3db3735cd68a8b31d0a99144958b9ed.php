    ...
    <div class="row">
        <div class="col-sm-12 col-lg-4">
            ...
            <div class="sp_site_card mb-4">
                ...
                <div class="card-body">
                    <form action="<?php echo e(url('create/withdraw')); ?>" method="post">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make(Config::theme() . 'layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\personal\crypto-script\resources\views/frontend/light/user/withdraw/index.blade.php ENDPATH**/ ?>