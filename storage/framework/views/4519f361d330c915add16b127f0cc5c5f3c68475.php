        ...
        <div class="col-lg-3">
            ...
            <div class="mt-4 p-4 bg-white rounded-lg">
                ...
                <ul class="user-action-list pb-2">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.user.login', $user->id)); ?>" target="_blank" class="user-action-btn">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.commision', $user)); ?>" class="user-action-btn">
                            <i class="fas fa-percentage mr-2"></i>
                            <?php echo e(__('Commission Log')); ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.payment.report', $user)); ?>" class="user-action-btn">
                            <i class="fas fa-file-invoice-dollar mr-2"></i>
                            <?php echo e(__('Payment Log')); ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.ticket.index', ['user' => $user->id])); ?>" class="user-action-btn">
                            <i class="fas fa-life-ring mr-2"></i>
                            <?php echo e(__('User Ticket')); ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.user.doc', $user->id)); ?>" class="user-action-btn">
                            <i class="fas fa-file-alt mr-2"></i>
