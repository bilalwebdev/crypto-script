                ...
                <div class="card-body text-center">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between">
                            ...
                            <span><?php echo e($withdraw->created_at->format('d F Y')); ?></span>

                        </li>
                        <li class="list-group-item d-flex justify-content-between">

                            <span><?php echo e(__('Payment Amount')); ?></span>
                            <span><?php echo e($withdraw->amount); ?></span>

                        </li>
                        <li class="list-group-item d-flex justify-content-between">

                            <span><?php echo e(__('Payment Method')); ?></span>
                            <span><?php echo e($withdraw->payment->name); ?></span>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\personal\crypto-script\resources\views/backend/withdraw/details.blade.php ENDPATH**/ ?>