            ...
            <div class="d-left-wrapper">
                ...
                <div class="row g-sm-4 g-3">
                        ...
                        <div class="d-card">
                            <div>
                                ...
                                <div class="text-center">
                                    <a class="btn sp_theme_btn btn-sm text-uppercase mt-4 w-100" href="<?php echo e(route('user.open-account')); ?>"><?php echo e(__('Open Live Account!')); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-12">
                        <div class="d-card">
                            <div>
                                ...
                                <div class="text-center">
                                    <a class="btn sp_theme_btn btn-sm text-uppercase mt-4 w-100" href="<?php echo e(route('user.deposit')); ?>"><?php echo e(__('Fund Your Account!')); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-12">
                        <div class="d-card">
                            <div>
                                <h5><?php echo e(__('Try us with our Demo Account!')); ?></h5>
                                
                                <div class="text-center">
                                    <a class="btn sp_theme_btn btn-sm text-uppercase mt-4 btn-block w-100" href="<?php echo e(route('user.open-account')); ?>?acc=demoacc"><?php echo e(__('Open Demo Account!')); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table sp_site_table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="tdStyle border-0"><b><?php echo e($item->balance); ?> <span class="text-uppercase"><?php echo e($item->currency); ?></span></b></span>
                                    </td>
                                    <td>
                                        <a href="<?php echo e(route('user.deposit')); ?>" class="btn sp_theme_btn btn-sm text-uppercase">Fund Now</a>
                                    </td>
                                </tr>
...
<?php echo $__env->make(Config::theme() . 'layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/crypto-script/main/resources/views/frontend/light/user/dashboard.blade.php ENDPATH**/ ?>